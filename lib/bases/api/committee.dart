...
class Committee {
  ...
  Committee.fromJson(Map<String, dynamic> json) {
    ...
    processMsg = json['process_msg'];
    committeeDetails = json['committee_details'] != null
        ? CommitteeDetails.fromJson(json['committee_details'])
        : null;
  }
...
class CommitteeDetails {
  Map<String, List<CommitteeMember>> committees = {};

  CommitteeDetails({required this.committees});

  CommitteeDetails.fromJson(Map<String, dynamic> json) {
    json.forEach((committeeName, members) {
      if (members != null && members is List) {
        committees[committeeName] =
            members.map((v) => CommitteeMember.fromJson(v)).toList();
      }
    });
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    committees.forEach((committeeName, members) {
      data[committeeName] = members.map((v) => v.toJson()).toList();
    });
    return data;
  }
